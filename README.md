  ...
  <body>
    <div class="jumbotron">
        <div class="container text-center">
            <h1 class="display-3">STARK Industries Limited</h1>
...
<div class="card" style="width: 412">
  ...
  <div class="card-body">
    ...
    <p class="card-text">
        <hr>
        <div class="col text-center">
        <h4 class="lead">Email: starkcompany@gmail.com</h4></br>
        <h4 class="lead">Phone: +1-1594227</h4></br>
        <h4 class="lead">Address: © STARK Industries Limited,Mountain View, California, United-States</h4>
        </div>
        <hr>
    </p>
  </div>
